...
// @ts-nocheck 
/*
 * This file exports the `TournamentRoster` model and its related types.
 *
...
export type GetTournamentRosterAggregateType<T extends TournamentRosterAggregateArgs> = {
      [P in keyof T & keyof AggregateTournamentRoster]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTournamentRoster[P]>
    : Prisma.GetScalarType<T[P], AggregateTournamentRoster[P]>
}
...
type GetTournamentRosterGroupByPayload<T extends TournamentRosterGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TournamentRosterGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TournamentRosterGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], TournamentRosterGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], TournamentRosterGroupByOutputType[P]>
      }
    >
  >
...
export type TournamentRosterCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<TournamentRosterFindManyArgs, 'select' | 'include' | 'distinct' | 'omit' | 'relationLoadStrategy'> & {
...
export interface TournamentRosterDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['TournamentRoster'], meta: { name: 'TournamentRoster' } }
  /**
   ...
   * })
  **/
  count<T extends TournamentRosterCountArgs>(
    args?: Prisma.Subset<T, TournamentRosterCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TournamentRosterCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends TournamentRosterGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, TournamentRosterGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTournamentRosterGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
