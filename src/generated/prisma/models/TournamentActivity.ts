...
// @ts-nocheck 
/*
 * This file exports the `TournamentActivity` model and its related types.
 *
...
export type GetTournamentActivityAggregateType<T extends TournamentActivityAggregateArgs> = {
      [P in keyof T & keyof AggregateTournamentActivity]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTournamentActivity[P]>
    : Prisma.GetScalarType<T[P], AggregateTournamentActivity[P]>
}
...
type GetTournamentActivityGroupByPayload<T extends TournamentActivityGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TournamentActivityGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TournamentActivityGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], TournamentActivityGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], TournamentActivityGroupByOutputType[P]>
      }
    >
  >
...
export type TournamentActivityCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<TournamentActivityFindManyArgs, 'select' | 'include' | 'distinct' | 'omit' | 'relationLoadStrategy'> & {
...
export interface TournamentActivityDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['TournamentActivity'], meta: { name: 'TournamentActivity' } }
  /**
   ...
   * })
  **/
  count<T extends TournamentActivityCountArgs>(
    args?: Prisma.Subset<T, TournamentActivityCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TournamentActivityCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends TournamentActivityGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, TournamentActivityGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTournamentActivityGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
