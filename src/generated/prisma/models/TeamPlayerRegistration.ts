...
// @ts-nocheck 
/*
 * This file exports the `TeamPlayerRegistration` model and its related types.
 *
...
export type GetTeamPlayerRegistrationAggregateType<T extends TeamPlayerRegistrationAggregateArgs> = {
      [P in keyof T & keyof AggregateTeamPlayerRegistration]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTeamPlayerRegistration[P]>
    : Prisma.GetScalarType<T[P], AggregateTeamPlayerRegistration[P]>
}
...
type GetTeamPlayerRegistrationGroupByPayload<T extends TeamPlayerRegistrationGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TeamPlayerRegistrationGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TeamPlayerRegistrationGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], TeamPlayerRegistrationGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], TeamPlayerRegistrationGroupByOutputType[P]>
      }
    >
  >
...
export type TeamPlayerRegistrationCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<TeamPlayerRegistrationFindManyArgs, 'select' | 'include' | 'distinct' | 'omit' | 'relationLoadStrategy'> & {
...
export interface TeamPlayerRegistrationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['TeamPlayerRegistration'], meta: { name: 'TeamPlayerRegistration' } }
  /**
   ...
   * })
  **/
  count<T extends TeamPlayerRegistrationCountArgs>(
    args?: Prisma.Subset<T, TeamPlayerRegistrationCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TeamPlayerRegistrationCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends TeamPlayerRegistrationGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, TeamPlayerRegistrationGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTeamPlayerRegistrationGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
