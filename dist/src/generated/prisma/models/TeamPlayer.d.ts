...
type GetTeamPlayerGroupByPayload<T extends TeamPlayerGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<TeamPlayerGroupByOutputType, T['by']> & {
...
export type TeamPlayerWhereInput = {
    ...
    role?: Prisma.EnumTeamPlayerRoleFilter<"TeamPlayer"> | $Enums.TeamPlayerRole;
    joinedAt?: Prisma.DateTimeFilter<"TeamPlayer"> | Date | string;
    ...
    updatedAt?: Prisma.DateTimeFilter<"TeamPlayer"> | Date | string;
...
export type TeamPlayerScalarWhereWithAggregatesInput = {
    ...
    role?: Prisma.EnumTeamPlayerRoleWithAggregatesFilter<"TeamPlayer"> | $Enums.TeamPlayerRole;
    joinedAt?: Prisma.DateTimeWithAggregatesFilter<"TeamPlayer"> | Date | string;
    ...
    updatedAt?: Prisma.DateTimeWithAggregatesFilter<"TeamPlayer"> | Date | string;
};
export type TeamPlayerCreateInput = {
    ...
    player: Prisma.UserCreateNestedOneWithoutTeamPlayerInput;
};
...
export type TeamPlayerUpdateInput = {
    ...
    player?: Prisma.UserUpdateOneRequiredWithoutTeamPlayerNestedInput;
};
...
export type TeamPlayerOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "role" | "joinedAt" | "teamId" | "playerId" | "createdAt" | "updatedAt", ExtArgs["result"]["teamPlayer"]>;
...
export type TeamPlayerCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<TeamPlayerFindManyArgs, 'select' | 'include' | 'distinct' | 'omit' | 'relationLoadStrategy'> & {
...
export interface TeamPlayerFieldRefs {
    ...
    readonly role: Prisma.FieldRef<"TeamPlayer", 'TeamPlayerRole'>;
    readonly joinedAt: Prisma.FieldRef<"TeamPlayer", 'DateTime'>;
    ...
    readonly updatedAt: Prisma.FieldRef<"TeamPlayer", 'DateTime'>;
}
/**
